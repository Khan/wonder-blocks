import{M as d}from"./index-35e12253.js";import{a as n,j as r,F as o}from"./jsx-runtime-309e447d.js";import{u as a}from"./index-506666d7.js";import"./iframe-97aa1d91.js";import"../sb-preview/runtime.js";import"./chunk-6P7RB4HF-938b085e.js";import"./index-d475d2ea.js";import"./index-9f32f44c.js";import"./_commonjsHelpers-de833af9.js";import"./index-9c2d1831.js";import"./inheritsLoose-9eefaa95.js";import"./assertThisInitialized-081f9914.js";import"./index-4733a090.js";import"./_baseIsEqual-976d9d82.js";import"./uniq-944679ca.js";import"./index-356e4a49.js";function c(i){const e=Object.assign({h1:"h1",p:"p",a:"a",code:"code",h2:"h2",pre:"pre",h3:"h3",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td"},a(),i.components);return r(o,{children:[n(d,{title:"Data / Exports / ScopedInMemoryCache",parameters:{chromatic:{disableSnapshot:!0}}}),`
`,n(e.h1,{id:"scopedinmemorycache",children:"ScopedInMemoryCache"}),`
`,r(e.p,{children:["This class implements an in-memory cache that can contain different scopes of cached data. This allows for quick removal of entire classes of data as identified by their scopes without having to iterate each cached item to find them. It implements the ",n(e.a,{href:"/docs/data-types-scopedcache--page",children:n(e.code,{children:"ScopedCache"})})," interface."]}),`
`,n(e.h2,{id:"constructor",children:"constructor()"}),`
`,n(e.pre,{children:n(e.code,{className:"language-ts",children:`new ScopedInMemoryCache(initialCache?: RawScopedCache)
`})}),`
`,n(e.p,{children:"Creates a new instance. An initial state for the cache can be provided."}),`
...
`})}),`
`,r(e.p,{children:["Purges all items from the cache. If a predicate is provided, only items for which the predicate returns ",n(e.code,{children:"true"})," will be purged; otherwise, the entire cache will be purged."]})]})}function h(i={}){const{wrapper:e}=Object.assign({},a(),i.components);return e?n(e,{...i,children:n(c,{...i})}):c(i)}const s=()=>{throw new Error("Docs-only story")};s.parameters={docsOnly:!0};const t={title:"Data / Exports / ScopedInMemoryCache",parameters:{chromatic:{disableSnapshot:!0}},tags:["stories-mdx"],includeStories:["__page"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:h};const E=["__page"];export{E as __namedExportsOrder,s as __page,t as default};
//# sourceMappingURL=exports.scoped-in-memory-cache.stories-b096a044.js.map
