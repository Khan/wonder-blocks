...
export { default as getElementIntersection, } from "./util/get-element-intersection";
export { AriaProps, ClickableHandlers, Intersection, IIdentifierFactory, StyleType, };
