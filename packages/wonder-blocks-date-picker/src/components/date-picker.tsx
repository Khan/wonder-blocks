...
interface Props {
     ...
     *
     * Note: This callback is called as the user types based on clearInvalidValueOnBlur:
     *
     * With clearInvalidValueOnBlur={false}:
     ...
     *
     * With clearInvalidValueOnBlur={true} (default):
     * - Called immediately only for valid in-range dates
     * - Out-of-range dates and invalid text only notify on blur (will auto-revert)
     *
     * For validation feedback, use clearInvalidValueOnBlur={false} and always update selectedDate
    ...
    /**
     * Whether to clear invalid/unparseable text from the input field on blur.
     *
     * When true (default):
    ...
    const renderInput = (
        ...
        return (
            <DatePickerInput
                ...
                modifiers={modifiers}
                clearInvalidValueOnBlur={clearInvalidValueOnBlur}
                testId={id && `${id}-input`}
            />
        );
    };
