...
describe("allPluralForms", () => {
    describe("likeFrench", () => {
        test.each`
            ...
            ${2}   | ${true}
            ${100} | ${true}
        `("likeFrench($number) = $form", ({number, form}: any) => {
    ...
    describe("ar", () => {
        test.each`
            ...
            ${1259} | ${4}
            ${501}  | ${5}
        `("allPluralForms.ar($number) = $form", ({number, form}: any) => {
    ...
    describe("cs", () => {
        test.each`
            ...
            ${0}   | ${2}
            ${5}   | ${2}
        `("allPluralForms.cs($number) = $form", ({number, form}: any) => {
    ...
    describe("hr", () => {
        test.each`
            ...
            ${20}  | ${2}
            ${25}  | ${2}
        `("allPluralForms.hr($number) = $form", ({number, form}: any) => {
    ...
    describe("lt", () => {
        test.each`
            ...
            ${25}  | ${1}
            ${20}  | ${2}
        `("allPluralForms.lt($number) = $form", ({number, form}: any) => {
    ...
    describe("lv", () => {
        test.each`
            ...
            ${11}  | ${2}
            ${111} | ${2}
        `("allPluralForms.lv($number) = $form", ({number, form}: any) => {
    ...
    describe("pl", () => {
        test.each`
            ...
            ${33}  | ${1}
            ${13}  | ${2}
        `("allPluralForms.pl($number) = $form", ({number, form}: any) => {
    ...
    describe("ro", () => {
        test.each`
            ...
            ${21}  | ${2}
            ${221} | ${2}
        `("allPluralForms.ro($number) = $form", ({number, form}: any) => {
    ...
    describe("ru", () => {
        test.each`
            ...
            ${13}  | ${2}
            ${11}  | ${2}
        `("allPluralForms.ru($number) = $form", ({number, form}: any) => {
    ...
    describe("sk", () => {
        test.each`
            ...
            ${10}  | ${2}
            ${100} | ${2}
        `("allPluralForms.sk($number) = $form", ({number, form}: any) => {
    ...
    describe("sr", () => {
        test.each`
            ...
            ${13}  | ${2}
            ${11}  | ${2}
        `("allPluralForms.sr($number) = $form", ({number, form}: any) => {
    ...
    describe("uk", () => {
        test.each`
            ...
            ${13}  | ${2}
            ${11}  | ${2}
        `("allPluralForms.uk($number) = $form", ({number, form}: any) => {
