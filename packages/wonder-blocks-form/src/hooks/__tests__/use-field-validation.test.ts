...
describe("useFieldValidation", () => {
    ...
    describe("Clearing the field value", () => {
        describe.each([true, false])(
            ...
            (instantValidation) => {
                it("should clear the errorMessage when the value is cleared", async () => {
                    // Arrange
                ...
                it("should call onValidate with null when the value is cleared", async () => {
                    // Arrange
                    const onValidate = jest.fn();
                ...
                it("should not clear the errorMessage when the value is cleared and the field is required", () => {
                    // Arrange
                    const {result, rerender} = renderHook(
                        ({value}) =>
                            useFieldValidation({
                    ...
                    // Assert
                    // Note: errorMessage is from the validate prop instead of the required
                    // prop because onChange validation wasn't triggered. Change was triggered by
                    // updating the value.
                    expect(result.current.errorMessage).toBe(testErrorMessage);
                });

                it("should not call onValidate with null when the value is cleared and the field is required", () => {
                    // Arrange
                    const onValidate = jest.fn();
                    const {rerender} = renderHook(
                        ({value}) =>
                ...
                it("should not clear the errorMessage when the value is cleared and the value is not cleared", () => {
                    // Arrange
                    const {result, rerender} = renderHook(
                        ({value}) =>
                            useFieldValidation({
                    ...
                    // Act
                    rerender({value: "tests"});

                    // Assert
                    expect(result.current.errorMessage).toBe(testErrorMessage);
                });

                it("should not call onValidate with null when the value is cleared and the value is not cleared", () => {
                    // Arrange
                    const onValidate = jest.fn();
                    const {rerender} = renderHook(
                        ({value}) =>
