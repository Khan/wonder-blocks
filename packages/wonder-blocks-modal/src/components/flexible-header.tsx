 ...
 *   FlexibleHeader doesn’t have to have the `titleId` prop however this is
 ...
 *   `some-random-id-FlexibleHeader`. This scope will also be passed to the title
 *   and subtitle elements: e.g. `some-random-id-FlexibleHeader-title`.
 *
 * Example:
 *
 * ```js
 * <FlexibleHeader
 *      title="Sidebar using FlexibleHeader"
 *      subtitle="subtitle"
 *      titleId="uniqueTitleId"
 *  />
 * ```
 */
export default function FlexibleHeader(props: Props) {
    const {
