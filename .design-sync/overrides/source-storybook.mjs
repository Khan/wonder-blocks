// forked from design-sync lib/source-storybook.mjs — filter storybook entries to WB's "manifest"-tagged canonical stories (drops Testing/Snapshots/Playtesting noise).
...
export async function resolveStorybook(ctx) {
  ...
  if (sbStatic) {
    ...
    for (const e of idxEntries) {
      ...
      // [WB fork] only WB manifest-tagged canonical stories (see NOTES.md)
      if (!(e.tags ?? []).includes('manifest')) continue;
