try{
var Qo=Object.create;var ut=Object.defineProperty;var en=Object.getOwnPropertyDescriptor;var tn=Object.getOwnPropertyNames;var rn=Object.getPrototypeOf,on=Object.prototype.hasOwnProperty;var w=(r,e)=>()=>(r&&(e=r(r=0)),e);var or=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),nn=(r,e)=>{for(var t in e)ut(r,t,{get:e[t],enumerable:!0})},sn=(r,e,t,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of tn(e))!on.call(r,n)&&n!==t&&ut(r,n,{get:()=>e[n],enumerable:!(o=en(e,n))||o.enumerable});return r};var an=(r,e,t)=>(t=r!=null?Qo(rn(r)):{},sn(e||!r||!r.__esModule?ut(t,"default",{value:r,enumerable:!0}):t,r));var d=w(()=>{});var y,u=w(()=>{y={NODE_ENV:"production",NODE_PATH:[],STORYBOOK:"true",PUBLIC_URL:"."}});var p=w(()=>{});var zs,Us,Ds,ir,Hs,Ys,Ws,Gs,qs,Zs,Xs,Ks,Js,Qs,ar,ei,ti,ri,oi,ni,si,ii,ai,je,li,Fe,ci,di,ne,ui,pi,hi,fi,V,mi,gi,yi,lr,vi,bi,xi,_i,wi,Si,Pi,Ti,Ci,ki,Ei,cr,Ni,Mi,Oi,Ri,Ai,$i,Bi,Ii,ji,Fi,Li,Vi,zi,Ui,Di,Hi,Yi,Y=w(()=>{d();u();p();zs=__STORYBOOKCOMPONENTS__,{A:Us,ActionBar:Ds,AddonPanel:ir,Badge:Hs,Bar:Ys,Blockquote:Ws,Button:Gs,ClipboardCode:qs,Code:Zs,DL:Xs,Div:Ks,DocumentWrapper:Js,ErrorFormatter:Qs,FlexBar:ar,Form:ei,H1:ti,H2:ri,H3:oi,H4:ni,H5:si,H6:ii,HR:ai,IconButton:je,IconButtonSkeleton:li,Icons:Fe,Img:ci,LI:di,Link:ne,ListItem:ui,Loader:pi,OL:hi,P:fi,Placeholder:V,Pre:mi,ResetWrapper:gi,ScrollArea:yi,Separator:lr,Spaced:vi,Span:bi,StorybookIcon:xi,StorybookLogo:_i,Symbols:wi,SyntaxHighlighter:Si,TT:Pi,TabBar:Ti,TabButton:Ci,TabWrapper:ki,Table:Ei,Tabs:cr,TabsState:Ni,TooltipLinkList:Mi,TooltipMessage:Oi,TooltipNote:Ri,UL:Ai,WithTooltip:$i,WithTooltipPure:Bi,Zoom:Ii,codeCommon:ji,components:Fi,createCopyToClipboardFunction:Li,getStoryHref:Vi,icons:zi,interleaveSeparators:Ui,nameSpaceClassNames:Di,resetComponents:Hi,withReset:Yi}=__STORYBOOKCOMPONENTS__});var Xi,Ki,Ji,Qi,ea,ta,ra,oa,na,sa,ia,aa,A,la,ca,da,ua,m,pa,ha,fa,ma,ga,ya,va,B=w(()=>{d();u();p();Xi=__STORYBOOKTHEMING__,{CacheProvider:Ki,ClassNames:Ji,Global:Qi,ThemeProvider:ea,background:ta,color:ra,convert:oa,create:na,createCache:sa,createGlobal:ia,createReset:aa,css:A,darken:la,ensure:ca,ignoreSsrWarning:da,isPropValid:ua,jsx:m,keyframes:pa,lighten:ha,styled:fa,themes:ma,typography:ga,useTheme:ya,withTheme:va}=__STORYBOOKTHEMING__});var Ea,Na,dr,k,Ma,Oa,Ra,ur,Aa,$a,Ba,ht,Ia,ja,ft,Fa,pr,La,I,Va,za,C,mt,Ua,J,Da,Ha,E,Ya,$=w(()=>{d();u();p();Ea=__REACT__,{Children:Na,Component:dr,Fragment:k,Profiler:Ma,PureComponent:Oa,StrictMode:Ra,Suspense:ur,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Aa,cloneElement:$a,createContext:Ba,createElement:ht,createFactory:Ia,createRef:ja,forwardRef:ft,isValidElement:Fa,lazy:pr,memo:La,useCallback:I,useContext:Va,useDebugValue:za,useEffect:C,useImperativeHandle:mt,useLayoutEffect:Ua,useMemo:J,useReducer:Da,useRef:Ha,useState:E,version:Ya}=__REACT__});var yt,fe,dn,un,pn,hr,fr,mr,Ve=w(()=>{d();u();p();$();B();Y();yt=function(r,e){return Object.defineProperty?Object.defineProperty(r,"raw",{value:e}):r.raw=e,r},fe=function(r){var e=r.config,t=r.defer,o=t===void 0?!1:t,n=E(o?void 0:e.url),s=n[0],i=n[1],l=E(!1),a=l[0],c=l[1];return C(function(){if(o){var h=requestAnimationFrame(function(){i(e.url)});return function(){return cancelAnimationFrame(h)}}},[o,e.url]),C(function(){c(!1)},[s]),m("div",{css:dn},!a&&m(V,{css:un},"Loading..."),m("iframe",{css:pn,src:s,allowFullScreen:e.allowFullscreen,onLoad:function(){return c(!0)}}))},dn=A(hr||(hr=yt([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
  ...
  >
    ...
    >
      Edited ${Oo(t)}
        ...
        `,Eo,Xr,uo,To,Ao])}get __images(){return{}}deselectNode(){this.selectedNode=null}get error(){return!D(this,e)||!D(this,o)?K({title:"Error",children:"Please call `__updateTree/1` method with a valid parameter."}):null}render(){if(this.error)return this.error instanceof Error?K({title:this.error.name||"Error",children:this.error.message}):typeof this.error=="string"?K({title:"Error",children:this.error}):this.error;let a=D(this,e),c=1/this.scale,h=`calc(var(--guide-thickness) * ${c})`,f=parseFloat(getComputedStyle(this).getPropertyValue("--guide-thickness")),g=parseFloat(getComputedStyle(this).getPropertyValue("--guide-tooltip-font-size"));return P`
