...
| Policy    | Value                | Description                                                                                                                                 |
| --------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `Reset`   | `"reset"`            | When the action of timing hook changes, the associated timer will be restarted.                                                             |
| `Passive` | `"passive"`          | When the action of timing hook changes, the associated timer will not be restarted. The new action will be fired when the timer next fires. |
