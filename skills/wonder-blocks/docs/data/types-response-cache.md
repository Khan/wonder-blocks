...
Each entry in the cache is of type [`CachedResponse`](./?path=/docs/packages-data-types-cachedresponse--docs). See the section on [server-side rendering](./?path=/docs/packages-data-server-side-rendering-and-hydration--docs) for more information.
