...
These options allow for the provision of a causal error instance as well as additional metadata that may be useful to the specific error being constructed (such as [`DataError`](./?path=/docs/packages-data-exports-dataerror--docs) or [`GqlError`](./?path=/docs/packages-data-exports-gqlerror--docs)).
