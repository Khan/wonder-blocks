...
Aborts all inflight requests that were started via [`useCachedEffect`](./?path=/docs/packages-data-exports-usecachedeffect--docs), [`useHydratableEffect`](./?path=/docs/packages-data-exports-usehydratableeffect--docs), or [`fetchTrackedRequests()`](./?path=/docs/packages-data-exports-fetchtrackedrequests--docs).
