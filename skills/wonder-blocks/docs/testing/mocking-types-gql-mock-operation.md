...
This defines the operation that a GraphQL mock will respond to. See [`mockGqlFetch`](./?path=/docs/packages-testing-mocking-exports-mockgqlfetch--docs) for more details.
