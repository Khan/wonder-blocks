...
When given an adapter type conforming to [`TestHarnessAdapter`](./?path=/docs/packages-testing-test-harness-types-testharnessadapter--docs), this type will represent that adapter type's configuration type.
