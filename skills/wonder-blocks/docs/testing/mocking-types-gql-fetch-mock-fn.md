...
This type represents the mocking API for use with the [Wonder Blocks Data GraphQL API](./?path=/docs/packages-data-graphql--docs). It is the type of the function returned by the [`mockGqlFetch()`](./?path=/docs/packages-testing-mocking-exports-mockgqlfetch--docs).
