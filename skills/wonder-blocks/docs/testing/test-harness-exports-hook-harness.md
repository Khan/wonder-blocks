...
This method is created by using [`makeHookHarness`](./?path=/docs/packages-testing-test-harness-exports-makehookharness--docs) with [`harnessAdapters.DefaultAdapters` and `harnessAdapters.DefaultConfigs`](./?path=/docs/packages-testing-test-harness-exports-harnessadapters--docs).
