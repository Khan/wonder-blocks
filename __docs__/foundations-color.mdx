...
#### Info
##### Subtle
<ColorGroup colors={semanticColor.feedback.info.subtle} group="feedback.info.subtle" />

#### Success
##### Subtle
<ColorGroup colors={semanticColor.feedback.success.subtle} group="feedback.success.subtle" />

#### Warning
##### Subtle
<ColorGroup colors={semanticColor.feedback.warning.subtle} group="feedback.warning.subtle" />

#### Critical
##### Subtle
<ColorGroup colors={semanticColor.feedback.critical.subtle} group="feedback.critical.subtle" />

### Status (deprecated)

<Banner kind="warning" text="These status tokens are deprecated and will be removed in the future. Please use the semantic feedback tokens instead: semanticColor.feedback" />
