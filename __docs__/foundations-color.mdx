...
import * as SemanticColorStories from "./wonder-blocks-tokens/semantic-color.stories"
...
<Canvas of={SemanticColorStories.CoreBorder} layout="fullscreen" />
...
<Canvas of={SemanticColorStories.CoreBackground} layout="fullscreen" />
...
<Canvas of={SemanticColorStories.CoreForeground} layout="fullscreen" />
...
<Canvas of={SemanticColorStories.FeedbackInfo} layout="fullscreen" />

#### Success

<Canvas of={SemanticColorStories.FeedbackSuccess} layout="fullscreen" />

#### Warning

<Canvas of={SemanticColorStories.FeedbackWarning} layout="fullscreen" />

#### Critical

<Canvas of={SemanticColorStories.FeedbackCritical} layout="fullscreen" />
...
<Canvas of={SemanticColorStories.Focus} layout="fullscreen" />
...
<Canvas of={SemanticColorStories.Surface} layout="fullscreen" />
...
<Canvas of={SemanticColorStories.Input} layout="fullscreen" />
...
<Canvas of={SemanticColorStories.LearningMath} layout="fullscreen" />

#### Border

<Canvas of={SemanticColorStories.LearningBorder} layout="fullscreen" />

#### Background

<Canvas of={SemanticColorStories.LearningBackground} layout="fullscreen" />


#### Foreground

<Canvas of={SemanticColorStories.LearningForeground} layout="fullscreen" />

#### Shadow

<Canvas of={SemanticColorStories.LearningShadow} layout="fullscreen" />
...
<Canvas of={SemanticColorStories.Khanmigo} layout="fullscreen" />

### Mastery

Standalone colors used only for communicating mastery.

<Canvas of={SemanticColorStories.Mastery} layout="fullscreen" />
