...
<View style={{marginBlock: sizing.size_160}}>
    <Banner
        kind="info"
...
- <LinkTo title="Packages / Styles / Focus Styles" story="docs">Focus</LinkTo>
- <LinkTo title="Packages / Styles / Min Target Size Styles" story="docs">Minimum target size</LinkTo>
