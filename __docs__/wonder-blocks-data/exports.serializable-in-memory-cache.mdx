...
<Meta
    title="Packages / Data / Exports / SerializableInMemoryCache"
/>

# SerializableInMemoryCache

This class is a specialization of <a href="./?path=/docs/packages-data-exports-scopedinmemorycache--docs">`ScopedInMemoryCache`</a>. This specialization requires that values added can be serialized to and from strings.
...
| ------------------------------------------------- | ----------------------- | ---------------------------------- |
| <a href="./?path=/docs/packages-data-exports-dataerror--docs">`DataError`</a> | `InvalidInputDataError` | Could not clone the initial cache. |
...
| Error Type                                        | Error Name          | Reason                     |
| ------------------------------------------------- | ------------------- | -------------------------- |
| <a href="./?path=/docs/packages-data-exports-dataerror--docs">`DataError`</a> | `InternalDataError` | Could not clone the cache. |
