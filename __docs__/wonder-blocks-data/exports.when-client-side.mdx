...
<Meta
    title="Packages / Data / Exports / WhenClientSide"
/>

# WhenClientSide

This enumeration is used with <a href="./?path=/docs/packages-data-exports-usehydratableeffect--docs">`useHydratableEffect`</a>. It defines how the hook should behave when rendering on the client.
