...
<Meta
    title="Packages / Data / Exports / GqlRouter"
    component={GqlRouter}
/>
...
The <a href="./?path=/docs/packages-data-exports-usegql--docs">`useGql`</a> (and therefore any hooks or components that use it) requires at least one `GqlRouter` in the component hierarchy above it or it will throw an error.
