...
<Meta
    title="Packages / Data / Exports / useCachedEffect()"
/>
...
| `fetchPolicy`          | <a href="./?path=/docs/packages-data-types-fetchpolicy--docs">`FetchPolicy`</a> | Fetch policy to use when fetching the data. Defaults to `FetchPolicy.CacheBeforeNetwork`.                                                                                                                                                                                                                                                                                                                            |
