...
<Meta title="Packages / Tokens / Utilities / fade" tags={["deprecated", "!manifest"]} />
...
>
    ...
    <View style={{fontSize: font.heading.size.xxxlarge}}>0.64</View>
    ...
    <PhosphorIcon icon={plusIcon} size="large" aria-label="plus" />
    <View style={{fontSize: font.heading.size.xxxlarge}}>0.5</View>
    <PhosphorIcon icon={equalsIcon} size="large" aria-label="equals" />
