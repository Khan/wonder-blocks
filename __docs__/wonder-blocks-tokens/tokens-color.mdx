...
<Meta title="Packages / Tokens / Color (Deprecated)" />
...
<View style={{marginBottom: tokens.spacing.xLarge_32}}>
    <Banner
        kind="warning"
        layout="full-width"
        text="`color` is deprecated! We recommend using semantic colors whenever possible, but if you need a color that doesn't fit into any of the categories, please reach out to us!"
        actions={[
            {
                type: "custom",
