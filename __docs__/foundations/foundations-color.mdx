...
Shadow colors are used for box shadows and other shadow effects on elements.

- `transparent` tokens provide elevation shadows at different intensities (`low`, `mid`, `high`) and tinted color variants (`color.strong`, `color.subtle`).
- `chonky` tokens are used for bold, decorative shadow effects on interactive elements like buttons.

<Canvas of={SemanticColorGroups.CoreShadow} layout="fullscreen" />
...
<Canvas of={SemanticColorGroups.FeedbackNeutral} layout="fullscreen" />
...
character art, gems, streaks, roles, and more.

#### Characters

<Canvas
    of={SemanticColorGroups.GraphicsCharactersFlesh}
    layout="fullscreen"
/>

#### Gems

<Canvas of={SemanticColorGroups.GraphicsGems} layout="fullscreen" />

#### Streaks

<Canvas of={SemanticColorGroups.GraphicsStreaks} layout="fullscreen" />

#### Progress

<Canvas of={SemanticColorGroups.GraphicsProgress} layout="fullscreen" />

#### Role

<Canvas of={SemanticColorGroups.GraphicsRole} layout="fullscreen" />

#### Neutral

Neutral background colors used for illustrative surfaces.

<Canvas of={SemanticColorGroups.GraphicsNeutral} layout="fullscreen" />

#### External brands

Colors that reflect external brand palettes, used exclusively when representing
those brands (e.g. third-party sign-in buttons).

<Canvas of={SemanticColorGroups.GraphicsExternalBrands} layout="fullscreen" />
...
in the future, see <a href="./?path=/docs/packages-tokens-deprecated-deprecated-semantic-colors--docs">Deprecated Semantic Colors</a>
