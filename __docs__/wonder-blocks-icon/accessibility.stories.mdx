...
<Canvas>
    <Story name="Icon contrast">
        <View style={{flexDirection: "row", marginBottom: Spacing.xSmall_8}}>
            <LabelMedium style={{display: "inline"}}>
                High contrast icon (GOOD):
            </LabelMedium>
            <Icon
                icon={icons.correct}
...
<Canvas>
    <Story name="Right to left icons">
        <View style={{flexDirection: "row", direction: "ltr"}}>
            <Icon icon={icons.caretRight} />
            <LabelMedium
                style={{display: "inline", marginInlineStart: Spacing.xSmall_8}}
            >
                Left to right
            </LabelMedium>
        </View>
        <View style={{flexDirection: "row", direction: "rtl"}}>
            <Icon icon={icons.caretLeft} />
            <LabelMedium
                style={{display: "inline", marginInlineStart: Spacing.xSmall_8}}
            >
                دائیں سے بائیں
...
-   [Accessible Icons: How to Make Them for Your Website](https://blog.hubspot.com/website/accessible-icons#:~:text=What%20are%20accessible%20icons%3F,their%20associated%20information%20or%20functionality.)
