...
* Icons should go on the opposite side as left-to-right languages
  ...
  * Directional glyphs are mirrored automatically by `PhosphorIcon`. See
    [Directional icons in RTL](./?path=/docs/packages-icon-phosphoricon-rtl-mirroring--docs).
...
Directional carets flip automatically in RTL. For the full whitelist and
guidance, see
[Directional icons in RTL](./?path=/docs/packages-icon-phosphoricon-rtl-mirroring--docs).
