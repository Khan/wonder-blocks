...
The `useSvgAttributes` hook determines what attributes should be applied
to an `svg` element.
...
<Canvas of={IconUtilitiesStories.UseSvgAttributesWithLabel} />
...
<Canvas of={IconUtilitiesStories.UseSvgAttributesWithNoLabel} />