...
<View style={styles.banner}>
    <Banner
        kind="info"
        text={<>The following components are lower-level building blocks. Most use cases should be covered by the Dialog and Launcher components above.<br />Can't get something working? Contact the WB team!</>}
    />
</View>
