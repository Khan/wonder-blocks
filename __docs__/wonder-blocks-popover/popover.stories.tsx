...
/**
 * With custom aria-describedby label - overrides the default aria-describedby
 */

export const CustomAriaDescribedBy: StoryComponentType = {
    args: {
        children: <Button>Open popover</Button>,
        content: ContentMappings.withTextOnly,
        placement: "top",
        ...
        testId: "",
        onClose: () => {},
        "aria-describedby": "Popover with custom aria described by label",
    } as PopoverArgs,
};

/**
 * With custom aria-label and custom aria-describedby label - overrides the default aria-describedby
 */

export const CustomAriaLabels: StoryComponentType = {
    args: {
        children: <Button>Open popover</Button>,
        content: ContentMappings.withTextOnly,
        placement: "top",
        ...
        testId: "",
        onClose: () => {},
        "aria-label": "Popover with custom aria label 2",
        "aria-describedby": "Popover with custom aria described by label",
    } as PopoverArgs,
};
