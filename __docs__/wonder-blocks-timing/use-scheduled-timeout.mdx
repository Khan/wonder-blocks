import * as UseScheduledTimeoutStories from './use-scheduled-timeout.stories';

import {Meta, Story, Canvas} from "@storybook/blocks";

<Meta of={UseScheduledTimeoutStories} />
...
<Canvas>
  <Story of={UseScheduledTimeoutStories.Immediately} />
</Canvas>
...
<Canvas>
  <Story of={UseScheduledTimeoutStories.OnDemandAndResolveOnClear} />
</Canvas>
