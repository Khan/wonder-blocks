...
<View style={styles.heroWrapper}>
    <View style={styles.heroBody}>
        <h1>Wonder Blocks (Web)</h1>

        Components and utilities you can drop right into your experiences so you
        can focus on solving the problems that really matter.
...
- <a href="https://khanacademy.atlassian.net/wiki/spaces/WB/pages/4396089552/Resources#Figma">Figma</a>
