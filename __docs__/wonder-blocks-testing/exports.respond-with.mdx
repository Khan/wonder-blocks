...
<Meta
    title="Packages / Testing / Mocking / Exports / RespondWith"
    parameters={{
        chromatic: {
...
mock request methods such as <a href="./?path=/docs/packages-testing-mocking-exports-mockgqlfetch--docs">`mockGqlFetch`</a>.

Each call takes an optional `signal` that can be used to control when the promise generated from the call resolves. See <a href="./?path=/docs/packages-testing-mocking-exports-settlecontroller--docs">`SettleController`</a> for related information.
