...
import BodyText from "../../packages/wonder-blocks-typography/src/components/body-text";
import Heading from "../../packages/wonder-blocks-typography/src/components/heading";
...
describe("Typography elements", () => {
    test.each`
        ...
        ${BodyText}      | ${"BodyText"}      | ${HTMLParagraphElement} | ${"HTMLParagraphElement"}
        ${BodyMonospace} | ${"BodyMonospace"} | ${HTMLSpanElement}      | ${"HTMLSpanElement"}
        ${Heading}       | ${"Heading"}       | ${HTMLHeadingElement}   | ${"HTMLHeadingElement"}
